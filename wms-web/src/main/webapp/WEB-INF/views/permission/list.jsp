        ...
        <div class="well-content">
          ...
          <div class="table_options top_options">
              <div>
                  ...
                  <a title="search permissions" href="javascript:Permission.queryList()" class="dark_green btn" style="margin-left:10px;"><i class="icon-search"></i></a>
                  <a title="add permission" href="javascript:App.goToPage('permission/add')" class="dark_green btn"><i class="icon-plus"></i></a>
...
<script>
    Permission.getTableData(jQuery.cookie("permission_iDisplayLength"));
</script>
