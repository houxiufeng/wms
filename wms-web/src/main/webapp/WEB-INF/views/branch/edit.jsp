    ...
    <div class="well light_gray">
	    <div class="top_bar">
		    <ul class="breadcrumb">
			    ...
			    <li><a href="javascript:void(0)">分支管理</a><span class="divider">/</span></li>
			    <li class="active">编辑分支</li>
		    </ul>
	    </div>
        ...
        <form id="branchForm">
	        ...
	        <div class="form_row">
		        <div class="span6" >
			        <div class="field">
				        <a href="javascript:Branch.update();" class="btn red">提交</a>
				        <a href="javascript:App.goToPage(appCtx+'/branch')" class="btn light_blue">取消</a>
			        </div>
		        </div>
	        </div>
