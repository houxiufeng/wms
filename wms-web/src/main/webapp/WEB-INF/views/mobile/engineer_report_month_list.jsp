...
<div class="span12" style="margin-top: 45px;">
    <div class="well blue">
        <div class="well-header">
            <h5 onclick="App.goToPage(appCtx+'/mobile/engineer/report/sum');">Back</h5>
            <h5 style="margin-left: 30%;">${fn:substring(monthBegin, 0,7)}</h5>
        </div>

        <div class="well-content">
            <input id="engineerId" type="hidden" value="${engineerId}">
...
<script>
    Order.getEngineerMonthOrders(1);
    ...
    jQuery("ul.nav li").on("click",function(){
        ...
        Order.getEngineerMonthOrders(status);
