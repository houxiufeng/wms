        ...
        <div class="well-content">
          ...
          <div class="table_options top_options">
              <div>
                  ...
                  <a title="search engineer" href="javascript:Engineer.queryList()" class="dark_green btn" style="margin-left:10px;"><i class="icon-search"></i></a>
                  <a title="add engineer" href="javascript:App.goToPage('engineer/add')" class="dark_green btn"><i class="icon-plus"></i></a>
              </div>
          </div>
          <!-- end   -->
