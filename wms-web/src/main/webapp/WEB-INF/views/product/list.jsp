    ...
    <div class="well light_gray">
        <div class="top_bar">
            <ul class="breadcrumb">
                ...
                <li class="active"><a href="javascript:void(0)">产品管理</a></li>
            </ul>
        </div>
        ...
        <div class="well-content">
          ...
          <div class="table_options top_options">
              <div>
                  ...
                  <input id="model" name="model" type="text" style="width:130px;">
                  <a href="javascript:Product.queryList()" class="blue btn" style="margin-left:10px;">查询</a>
                  <a href="javascript:App.goToPage('product/add')" class="blue btn">添加</a>
              </div>
          </div>
          <!-- end   -->
