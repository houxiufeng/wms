...
<div class="well light_gray">
	<div class="top_bar">
		<ul class="breadcrumb">
			<li><a href="javascript:void(0);">产品中心</a> <span class="divider">/</span></li>
			<li><a href="javascript:void(0)">产品管理</a><span class="divider">/</span></li>
	...
	<div class="well-content">
		<form id="productForm">
			...
			<div class="form_row">
				<div class="span5">
					...
					<div class="field">
						...
						<a href="javascript:Product.addBrand();" class="btn light_blue">+</a>
					</div>
				</div>
				<div class="span5">
			...
			<div class="form_row">
				<div class="span5">
					<label class="field_name align_left" style="font-weight: bold;font-size: 14px;">维保人员信息</label>
				</div>
			</div>
			...
			<div class="form_row">
				<div class="span5" >
					<div class="field">
						<a href="javascript:Product.update();" class="btn red">提交</a>
						<a href="javascript:App.goToPage(appCtx+'/product')" class="btn light_blue">取消</a>
					</div>
				</div>
			</div>
