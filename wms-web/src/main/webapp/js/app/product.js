		...
		getTableData: function(){
			jQuery('#productTable').dataTable({
		        ...
		        aoColumns:[{
		            ...
		            sTitle : "操作",
		            mRender: function(value, type ,data){
		            	return '<a class="btn edit" href="javascript:Product.edit('+ value + ')"><i class="icon-edit"></i></a>\
		            	        <a class="btn edit" href="javascript:Product.delete('+ value + ')"><i class="icon-trash"></i></a>';
		            }
